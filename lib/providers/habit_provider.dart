...
class HabitProvider extends ChangeNotifier {
  ...
  int getCompletionsThisWeek(Habit habit) {
    ...
    return habit.completions.where((c) => c.isAfter(startOfWeek) && c.isBefore(endOfWeek)).length;
  }
  ...
  List<Habit> getHabitsForDay(DateTime date) {
    return _habits.where((habit) {
      ...
      if (habit.frequency == HabitFrequency.weeklyFlexible) return true; // Flexible habits show up every day until weekly goal is met
