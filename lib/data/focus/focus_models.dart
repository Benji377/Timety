...
@HiveType(typeId: 3)
enum FocusModeType {
  @HiveField(0) stopwatch,
  @HiveField(1) pomodoro,
  @HiveField(2) flexible,
  @HiveField(3) custom
}
...
@HiveType(typeId: 8)
class SessionPhase {
  @HiveField(0) final PhaseType type;
...
class FocusMode {
  ...
  @HiveField(2) final FocusModeType type;
  @HiveField(3) final List<SessionPhase> phases; // The sequence of nodes
  @HiveField(4) final bool isSystem; // Locks the mode from being edited/deleted
...
class FocusSession {
  @HiveField(0) final String id;
  @HiveField(1) final String modeId;
