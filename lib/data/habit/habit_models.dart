...
@HiveType(typeId: 10)
enum HabitFrequency {
  @HiveField(0) daily,           // e.g., Write a report every day
  @HiveField(1) weeklyExact,     // e.g., Trash out on Tuesdays
  @HiveField(2) weeklyFlexible,  // e.g., Workout 3x a week
}
