...
class HabitHistorySheet extends StatefulWidget {
  final Habit habit;
  final Function(DateTime) onDateSelected;
  final Function(DateTime) onDateDeselected;

  const HabitHistorySheet({
    super.key,
    required this.habit,
  ...
  @override
  State<HabitHistorySheet> createState() => _HabitHistorySheetState();
}

class _HabitHistorySheetState extends State<HabitHistorySheet> {
