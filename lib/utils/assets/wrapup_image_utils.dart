...
import '../../data/user/wrapup_stat_row.dart';
...
class WrapUpImageGenerator {
  ...
  static void _drawStats(
    ...
    final rows = [
      ...
      WrapUpStatRow(Icons.repeat, AppTheme.habitColor, '$habits', 'Habits Built'),
    ];
  ...
  static void _drawStatRow(Canvas canvas, WrapUpStatRow row, double y) {
