...
class ScreenshotTest {
    ...
    fun generateScreenshots() {
        ...
        // 2. Stats
        try {
            composeTestRule.onNodeWithContentDescription("Statistics", ignoreCase = true)
                .performClick()
            composeTestRule.waitForIdle()
            ...
            println("Stats navigation failed")
        }

        // 3. Calendar
        try {
            composeTestRule.onNodeWithContentDescription("Calendar", ignoreCase = true)
                .performClick()
            composeTestRule.waitForIdle()
            ...
            println("Calendar navigation failed")
        }
        ...
        try {
            ...
            println("Focus Modes navigation failed")
        }
